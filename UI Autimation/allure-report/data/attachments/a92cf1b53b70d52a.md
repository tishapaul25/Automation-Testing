...
- Name: example.spec.js >> UI Automation Testing >> get started link
...
```ts
  ...
  4  | 
  5  | test.describe("UI Automation Testing", () => {
  6  | 
...
> 18 |   await page.getByRole('link', { name: 'Get started' }).click();
     |                                                         ^ Error: locator.click: Test timeout of 30000ms exceeded.
  19 | 
  20 |   // Expects page to have a heading with the name of Installation.
